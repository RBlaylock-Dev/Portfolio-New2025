  ...
  return (
    <div className="App">
      <header className="App-header">  <label className="switch">
        ...
        <a href="https://github.com/rblaylock-dev" target="_blank"><img src="../dist/Githublogo.png" alt="GitHub Logo"></img></a><a href="https://www.linkedin.com/in/rblaylock286/" target="_blank"><img src="../dist/linkedinlogo.png" alt="LinkedIn Logo"></img></a>
        
      </header>
      <main>
        <section id="about-me">
          <img src="../dist/linkedinlogo.png" alt="Robert Blaylock" className="profile-pic" />
          <h2>About Me</h2>
